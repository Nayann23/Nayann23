...
* **Applied Machine Learning Systems:** My work bridges the gap between raw model weights and end-to-end user evaluation, building interactive data interfaces.
...
**I recently launched [SynapseDocs]([https://github.com/usernamehere](https://synapse-docs-ten.vercel.app/)) — a premium documentation interface designed to bridge the gap between complex model code and stakeholder-ready insights. It serves as my primary engineering journal for deploying end-to-end Data Science systems.**
...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=python,tensorflow,pytorch,sklearn,opencv,git,github&theme=dark" />
  </a>
</p>
